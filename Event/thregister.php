...
.form-image1 img {
    max-width: 100%;
    height: auto;
    max-height: 250px; /* Medium height for the image */
...
.checkbox-group1 label a {
    color: #007bff;
    text-decoration: none;
}

.checkbox-group1 label a:hover {
...
$query = "INSERT INTO tbl_treasure (t_college, t_name1, t_name2, t_name3, t_name4, t_email, t_phno, t_trn_id, t_status) 
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
mysqli_stmt_bind_param($stmt, 'ssssssssi', $cname, $name1, $name2, $name3, $name4, $email, $phoneno, $transactionid, $status);
