            ...
            <label for="payment">Payment</label>
                    ...
                    <div class="form-group">
                        <a id="paymentlink" href=""><button
                                type="button" class="btn">Pay Now</button></a>
                    </div>
                    <div class="form-group">
...
$query = "INSERT INTO tbl_bgmi (t_college, t_name1, t_name2, t_name3, t_name4, t_email, t_phno, t_trn_id, t_status) 
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<script>
var upiID = "crazygamer86-1@okaxis";
var amount = 200;
