...
$query="insert  into  tbl_bgmi(t_college,t_name1,t_name2,t_name3,t_name4,t_email,t_phno,t_trn_id,t_status)values('$cname','$name1','$name2','$name3','$name4','$email','$phoneno','$transactionid',$status)";
